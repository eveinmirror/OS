...
pts=5
quick_check 'check_buddy_free_count' \
    '[buddy_check] alloc 1 page OK' \
    '[buddy_check] free 1 page OK' \
    '[buddy_check] alloc 8 pages OK' \
    '[buddy_check] free 8 pages OK' \
    '[buddy_check] merge test passed'
